...
class orderLineProquotes(models.Model):
    ...
    def _compute_amount(self):
        ...
        for line in self:
            ...
            _logger.info('RENTAL CALCULATIONS: display_price: product_pricing_id: %s, rental_period: %s, recurrence_id: %s', str(product_template.display_price), str(product_pricing_id), str(rental_period) if rental_period else 'None', "temporary removal")
            # line_rental_price = 0
