...
# Odoo 19 trimmed odoo.tools (CountingStream, discardattr, LastOrderedSet, etc.
# were removed). Import only the names this module actually uses.
from odoo.tools import SQL, OrderedSet, get_lang
