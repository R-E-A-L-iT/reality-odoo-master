...
class order(models.Model):
    ...
    #         # product_pricing_id = product_template.product_pricing_ids[:1] if product_template.product_pricing_ids else None
    ...
    #         # _logger.info('RENTAL CALCULATIONS: display_price: %s product_pricing_id: %s, rental_period: %s, recurrence_id: %s', str(product_template.display_price), str(product_pricing_id), str(rental_period) if rental_period else 'None', "temporary removal")
    #         # line_rental_price = 0
    ...
    #         else:
    #             _logger.info('RENTAL CALCULATIONS: Requirements not met. product_id.rent_ok: %s, duration_days: %s, rental_period.name: %s', line.product_id.rent_ok, duration_days, "no name")
