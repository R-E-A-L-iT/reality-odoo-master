...
import proquotes.models.product_sync_common as product_sync_common
...
class TestModulePricelist(TransactionCase):
    ...
    def setUp(self):
        ...
        self.sync_pricelist = self.sync_model.getSync_pricelist(
            "TEST_DATA_ODOO", self.pricelist_data)
        self.product_model = self.sync_model.getSync_product(
            "TEST_DATA_ODOO", self.pricelist_data)

    # def ProductToPricelist(self, product, pricelistName, price):
