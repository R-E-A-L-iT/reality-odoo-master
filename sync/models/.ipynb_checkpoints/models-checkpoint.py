...
class sync(models.Model):
    ...
    def getCell(self):
        ...
        request_url = "https://spreadsheets.google.com/feeds/cells/%s/1/private/full/R3C1?access_token=%s&alt=json&fields=entry" % (template_id, access_token)
        ...
        raise UserError(_(str(req.json()["content"]["$t"])))