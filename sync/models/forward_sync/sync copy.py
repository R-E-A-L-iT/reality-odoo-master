...
class sync(models.Model):
    ...
    _sync_cancel_reason = "<h1>The Sync Process was cancelled (forced to quit) and no records were updated.</h1><p>Hi. It's me again. I know you hate these emails, but it's okay, because I don't hate you back, and I'm just trying to help :)</p><h1>The Following Rows of The Google Sheet Table are invalid</h1>"
