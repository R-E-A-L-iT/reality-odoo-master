    ...
    def syncContacts(self):
        ...
        if ("Name" in self.sheet[0]):
            ...
            msg = utilities.buildMSG(
                msg, self.sheetName, "Header", "Name Missing")
            columnsMissing = True
        ...
        if ("Company" in self.sheet[0]):
            ...
            msg = utilities.buildMSG(
                msg, self.sheetName, "Header", "Company Missing")
            columnsMissing = True
        ...
        if ("OCID" in self.sheet[0]):
            ...
            msg = utilities.buildMSG(
                msg, self.sheetName, "Header", "OCID Missing")
            columnsMissing = True
        ...
        while (True):
            ...
            if (i == len(self.sheet) or str(self.sheet[i][columns["continue"]]).upper() != "TRUE"):
                break
