        ...
        omni360: {
            ...
            slots: {
                ...
                attachment: {
                    ...
                    detailTitle: { en_US: 'Mount It However You Work', fr_CA: 'Montez-le comme vous travaillez', es_ES: 'Móntelo como usted trabaja' },
                    detailBody:  { en_US: 'The configurable bottom face accepts tribrach interfaces, 5/8″ and 3/8″ UNC survey screws, an RTC stub quick-release, and Gitzo-compatible tripod mounts — so the same body drops straight onto tribrachs, tripods, survey poles, and robotic systems without a single extra adapter.', fr_CA: 'La face inférieure configurable accepte des interfaces tribraque, des vis d\'arpentage 5/8″ et 3/8″ UNC, un dégagement rapide à talon RTC et des montages de trépied compatibles Gitzo — le même corps s\'installe directement sur tribraques, trépieds, perches d\'arpentage et systèmes robotiques, sans adaptateur supplémentaire.', es_ES: 'La cara inferior configurable acepta interfaces de tribraquia, tornillos de topografía 5/8″ y 3/8″ UNC, una liberación rápida de talón RTC y montajes de trípode compatibles con Gitzo — el mismo cuerpo se instala directamente en tribraquias, trípodes, postes de topografía y sistemas robóticos, sin un adaptador adicional.' },
                ...
                back: {
                    ...
                    detailTitle: { en_US: 'Built-In Protection, On Demand', fr_CA: 'Une protection intégrée, à la demande', es_ES: 'Protección incorporada, cuando la necesite' },
                    detailBody:  { en_US: 'Three protective bars ring the perimeter and adjust between compressed and extended positions, shielding the mounted scanner and stabilizing the rig in tight or rough environments. A Y-bar connector ties them together for extra rigidity and even more mounting points.', fr_CA: 'Trois barres de protection entourent le périmètre et se règlent entre une position compressée et étendue, protégeant le scanner monté et stabilisant l\'ensemble dans les environnements exigus ou accidentés. Un connecteur en Y les relie pour plus de rigidité et davantage de points de fixation.', es_ES: 'Tres barras de protección rodean el perímetro y se ajustan entre una posición comprimida y extendida, protegiendo el escáner montado y estabilizando el conjunto en entornos reducidos o exigentes. Un conector en Y las une para mayor rigidez y más puntos de montaje.' },
                ...
                hatch: {
                    ...
                    detailTitle: { en_US: 'Rig Exactly What the Job Needs', fr_CA: 'Équipez exactement ce dont le chantier a besoin', es_ES: 'Equipe exactamente lo que el trabajo necesita' },
                    detailBody:  { en_US: '3/8″ threaded holes and cold-shoe interfaces line the sides, ready for high-powered lights in the dark, a 360 camera for combined-capture workflows, a phone or tablet to monitor capture in real time, or handles for heavier setups.', fr_CA: 'Des trous filetés 3/8″ et des interfaces «cold shoe» bordent les côtés, prêts pour des éclairages puissants dans l\'obscurité, une caméra 360° pour des flux combinés, un téléphone ou une tablette pour surveiller la capture en temps réel, ou des poignées pour les configurations plus lourdes.', es_ES: 'Orificios roscados 3/8″ e interfaces «cold shoe» bordean los laterales, listos para luces potentes en la oscuridad, una cámara 360° para flujos combinados, un teléfono o tableta para supervisar la captura en tiempo real, o manijas para configuraciones más pesadas.' },
                ...
                screw: {
                    ...
                    detailTitle: { en_US: 'One Top, Every Scanner', fr_CA: 'Un seul sommet, tous les scanners', es_ES: 'Una sola parte superior, todos los escáneres' },
                    detailBody:  { en_US: 'A standardized top mounting interface accepts an RTC stub, Wild prism, 5/8″ or 3/8″ male screw, or the BLK2GO clamp — swap in seconds to run the RTC360, BLK2GO, BLK ARC, or BLK360 G2 on the exact same body.', fr_CA: 'Une interface de montage supérieure standardisée accepte un talon RTC, un prisme Wild, une vis mâle 5/8″ ou 3/8″, ou la pince BLK2GO — permutez en quelques secondes pour utiliser le RTC360, le BLK2GO, le BLK ARC ou le BLK360 G2 sur exactement le même corps.', es_ES: 'Una interfaz de montaje superior estandarizada acepta un talón RTC, un prisma Wild, un tornillo macho 5/8″ o 3/8″, o la pinza BLK2GO — intercambie en segundos para usar el RTC360, el BLK2GO, el BLK ARC o el BLK360 G2 en exactamente el mismo cuerpo.' },
