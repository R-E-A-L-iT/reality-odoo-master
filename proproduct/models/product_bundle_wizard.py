...
class ProductBundleWizard(models.TransientModel):
    ...
    def action_add_bundle_to_document(self):
        ...
        if active_model == 'sale.order':
            ...
            currency = doc.pricelist_id.currency_id
            is_rental = getattr(doc, 'is_rental', False)  # handle case where field may not exist
            ...
            bundle_price_line = doc.order_line.create({
                'order_id': doc.id,
